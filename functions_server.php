...
function gpdeal_scripts() {
   ...
   wp_enqueue_style('reset', auto_version(wp_make_link_relative(get_template_directory_uri() . '/assets/css/reset.css')));
    ...
    wp_enqueue_script('jquery.cookie.min', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-cookie/1.4.1/jquery.cookie.min.js', array(), '1.4.1', true);
    ...
    wp_enqueue_script('translations_js', auto_version(wp_make_link_relative(get_template_directory_uri() . '/assets/js/translations.js')), array(), false, true);
