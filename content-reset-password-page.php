...
<div class="ui vertical masthead  segment container">
    ...
    <div class="ui signup_contenair basic segment container">
        ...
        <div class="ui fluid card">
            <div class="content">
                <form id='reset_password_form'  method="POST" action="<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('my-account', 'gpdealdomain') . '/' . __('change-the-password', 'gpdealdomain')))); ?>" class="ui form" autocomplete="off">
                    <div class="fields">
                        ...
                        <div class="twelve wide field">
                            <div class="ui input right icon old_password">
                                ...
                                <input id='old_password' type="password" name="old_password" placeholder="<?php echo __("Current Password", 'gpdealdomain') ?>" class="visible_password">
                            </div>
                        </div>
                    </div>
