                                ...
                                <div class="fields">
                                    ...
                                    <div class="twelve wide field">
                                        <div class="ui input icon locality">
                                            ...
                                            <input id="locality" type="text" class="locality" name='locality' placeholder="<?php _e("City, Country", "gpdealdomain"); ?>" value="<?php echo $locality ?>">
                                        </div>
                                    </div>                        
                                </div> 
                                <div class="fields">
                                ...
                                <div class="fields">
                                    ...
                                    <div class="twelve wide field">
                                        <div class="ui input icon locality_pro">
                                            ...
                                            <input id="locality_pro" type="text" class="locality" name='locality_pro' placeholder="<?php _e("City, Country", "gpdealdomain"); ?>" value="<?php echo $locality_pro ?>">
                                        </div>
                                    </div>                        
                                </div>
