                ...
                <div class="content">
                    ...
                    <div class="description">
                        ...
                        <div id="forgot_password_action" class="ui two column stackable grid">
                            ...
                            <div class="column">
                                <a href="<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('forgot-your-password', 'gpdealdomain')))); ?>" class="ui fluid basic green button"><?php _e("Try different e-mail", "gpdealdomain"); ?></a>
                            </div>
                        </div>
                        <?php endif ?>
                    </div>
                    <p style="text-align: center;">
                        <?php echo __("If you don't see our e-mail, check your spam folder", "gpdealdomain") ?>.
                    </p>
                </div>
            </div>
