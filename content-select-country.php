    ...
    <div class="menu">
        <div class="item" data-value="+93"><i class="af flag"></i>Afghanistan</div>
        <div class="item" data-value="+27"><i class="ax flag"></i>Aland Islands</div>
        <div class="item" data-value="+235"><i class="al flag"></i>Albania</div>
        ...
        <div class="item" data-value="+237"><i class="cm flag"></i>Cameroon</div>
        ...
        <div class="item" data-value="+33"><i class="fr flag"></i>France</div>
        ...
        <div class="item" data-value="+221"><i class="sn flag"></i>Senegal</div>
        ...
        <div class="item" data-value="+1"><i class="us flag"></i>United States</div>
