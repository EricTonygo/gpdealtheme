...
<div class="ui vertical masthead segment container review_confirm">
    <div class="ui content_steps_select_transport_offer container">
        <div class="ui two top attached steps select_transport_offers">
            ...
            <a class="disabled step" href="<?php echo esc_url(get_permalink(get_page_by_path(__('select-transport-offers', 'gpdealdomain') . '/' . __('payment', 'gpdealdomain')))); ?>">
    ...
    <div class="ui attached segment select_transport_offers">
        ...
        <!--                                                    <div class="content_image" <?php if ($profile_picture_id): ?> style="background-image: url(<?php echo wp_make_link_relative(wp_get_attachment_url($profile_picture_id)); ?>);" <?php else: ?> style="background-image: url(<?php echo wp_make_link_relative(get_template_directory_uri()) ?>/assets/images/avatar.png);" <?php endif ?>>
                                            ...
                                            <!--                                            <div class="extra content">
                                                                                            <a id='remove_selected_transport_offer<?php echo $transport_offer_id; ?>' class="ui fluid green button remove_selected_transport_offer"  href="<?php echo esc_url(add_query_arg(array('id' => $transport_offer_id, "remove-selected-transport-offer" => 'true'), get_permalink())); ?>"><?php echo __("Remove", "gpdealdomain"); ?></a>
                                                                                        </div>-->
                                        </div>                                        
                                    </div>
                                    <?php
                    ...
                    <div class="extra content">
                        <a id="continue_to_confirm_transaction" href="<?php echo esc_url(get_permalink(get_page_by_path(__('select-transport-offers', 'gpdealdomain') . '/' . __('payment', 'gpdealdomain')))); ?>" class="ui green button right floated">
                            <?php _e("Continue to confirm transaction", "gpdealdomain"); ?>
                        </a>
                    </div>
                </div>
            </div>
