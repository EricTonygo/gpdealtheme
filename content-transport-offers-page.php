    ...
    <div class="ui stackable grid">
        <div id="left_content_account" class="four wide column">
            <div class="ui vertical fluid tabular menu">
                ...
                <a class="item" href="<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('my-account', 'gpdealdomain') . '/' . __('shipments', 'gpdealdomain')))); ?>">
                    <?php echo __('My shipments', 'gpdealdomain') ?>
                </a>
                <a class="active item" href='<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('my-account', 'gpdealdomain') . '/' . __('transport-offers', 'gpdealdomain')))); ?>'>
                    ...
                    <div class="ui content_packages_transports main_right_content fluid card">
                        <div class="content">
                            ...
                            <?php if (get_user_meta(get_current_user_id(), "registration-completed", true) == 2): ?>
                                <a href="<?php echo wp_make_link_relative(get_permalink(get_page_by_path(__('my-account', 'gpdealdomain') . '/' . __('transport-offers', 'gpdealdomain') . '/' . __('write', 'gpdealdomain')))); ?>" class="ui green right floated button" ><?php echo __('Publish new', 'gpdealdomain') ?>!</a>
                            <?php endif ?>
                        </div>
                        <div class="content content_packages_transports">
                            <?php if (get_user_meta(get_current_user_id(), "registration-completed", true) != 2): ?>
                                <div class="ui message">
                                    ...
                                    <p>
                                        <?php _e("You must complete your registration to be able to add a new transport offer", "gpdealdomain"); ?>
                                    </p>
                                </div>
                            <?php endif ?>
